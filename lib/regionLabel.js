...
export class RegionLabel {
    ...
    createGroupings(geojson) {
        ...
        //set totalBbox to the bounding box which encompasses ALL the GeoJSON
        this.totalBbox = generateBoundingBox(vertsOnly);
    ...
    normalizeVertices(canvas) {
        ...
        //set totalBbox to the bounding box which encompasses all the normalized vertices
        this.totalBbox = generateBoundingBox(vertsOnly);
    };
