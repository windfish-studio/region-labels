...
function main(shapes, ctx) {
    var regX, regY, lines, spline, splineEquation, landArea, shapesArea = 0,
        longestLineSlope,longestLineIntercept, longestLinePSlope, longestLinePIntercept,
    ...
    var newLine = function(slope, yIntercept, flipped) {
        ...
        var line = {start: lineStart, end: lineEnd};
        return line
    };
