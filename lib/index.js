...
function RegionLabel(shapes, text) {
    ...
    this.translate = function(point, center, slope){
    ...
    this.getExtremePoint = function(direction){
        var my = this;
        ...
        var getPoint = function(index){
            ...
            var p = my.untranslate([x, y], rayCenter, longestLineSlope);
        ...
        if(!lastPoint)
            lastPoint = getPoint(i - delta);

        var p = getHitPoints(world, lastPoint.absolute, point.absolute)[0];
        var t = this.translate(p, rayCenter, longestLineSlope);
    ...
    firstPoint = this.getExtremePoint('first');
    lastPoint = this.getExtremePoint('last');
